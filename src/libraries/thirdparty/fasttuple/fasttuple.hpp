...
public:
	...
	template <typename Type0_t2>
	FORCEINLINE constexpr auto & operator=( CTuple<Type0_t2> &&tuple )
	// Move assign from rvr tuple to enable std::tie like behaviour
	{
		_0 = std::move(tuple._0);
		return *this;
	}
...
public:
	...
	template <typename Type0_t2, typename Type1_t2>
	FORCEINLINE constexpr auto & operator=( CTuple<Type0_t2,Type1_t2> &&tuple )
	// Move assign from rvr tuple to enable std::tie like behaviour
	{
		_0 = std::move(tuple._0);
		_1 = std::move(tuple._1);
		return *this;
	}
...
public:
	...
	template <typename Type0_t2, typename Type1_t2, typename Type2_t2>
	FORCEINLINE constexpr auto & operator=( CTuple<Type0_t2,Type1_t2,Type2_t2> &&tuple )
	// Move assign from rvr tuple to enable std::tie like behaviour
	{
		_0 = std::move(tuple._0);
		_1 = std::move(tuple._1);
		_2 = std::move(tuple._2);
		return *this;
	}
...
public:
	...
	template <typename Type0_t2, typename Type1_t2, typename Type2_t2, typename Type3_t2>
	FORCEINLINE constexpr auto & operator=( CTuple<Type0_t2,Type1_t2,Type2_t2,Type3_t2> &&tuple )
	// Move assign from rvr tuple to enable std::tie like behaviour
	{
		_0 = std::move(tuple._0);
		_1 = std::move(tuple._1);
		_2 = std::move(tuple._2);
		_3 = std::move(tuple._3);
		return *this;
	}
...
public:
	...
	template <typename Type0_t2, typename Type1_t2, typename Type2_t2, typename Type3_t2, typename Type4_t2>
	FORCEINLINE constexpr auto & operator=( CTuple<Type0_t2,Type1_t2,Type2_t2,Type3_t2,Type4_t2> &&tuple )
	// Move assign from rvr tuple to enable std::tie like behaviour
	{
		_0 = std::move(tuple._0);
		_1 = std::move(tuple._1);
...
public:
	...
	template <typename Type0_t2, typename Type1_t2, typename Type2_t2, typename Type3_t2, typename Type4_t2, typename Type5_t2>
	FORCEINLINE constexpr auto & operator=( CTuple<Type0_t2,Type1_t2,Type2_t2,Type3_t2,Type4_t2,Type5_t2> &&tuple )
	// Move assign from rvr tuple to enable std::tie like behaviour
	{
		_0 = std::move(tuple._0);
		_1 = std::move(tuple._1);
...
public:
	...
	template <typename Type0_t2, typename Type1_t2, typename Type2_t2, typename Type3_t2, typename Type4_t2, typename Type5_t2, typename Type6_t2>
	FORCEINLINE constexpr auto & operator=( CTuple<Type0_t2,Type1_t2,Type2_t2,Type3_t2,Type4_t2,Type5_t2,Type6_t2> &&tuple )
	// Move assign from rvr tuple to enable std::tie like behaviour
	{
		_0 = std::move(tuple._0);
		_1 = std::move(tuple._1);
...
public:
	...
	template <typename Type0_t2, typename Type1_t2, typename Type2_t2, typename Type3_t2, typename Type4_t2, typename Type5_t2, typename Type6_t2, typename Type7_t2>
	FORCEINLINE constexpr auto & operator=( CTuple<Type0_t2,Type1_t2,Type2_t2,Type3_t2,Type4_t2,Type5_t2,Type6_t2,Type7_t2> &&tuple )
	// Move assign from rvr tuple to enable std::tie like behaviour
	{
		_0 = std::move(tuple._0);
		_1 = std::move(tuple._1);
...
public:
	...
	template <typename Type0_t2, typename Type1_t2, typename Type2_t2, typename Type3_t2, typename Type4_t2, typename Type5_t2, typename Type6_t2, typename Type7_t2, typename Type8_t2>
	FORCEINLINE constexpr auto & operator=( CTuple<Type0_t2,Type1_t2,Type2_t2,Type3_t2,Type4_t2,Type5_t2,Type6_t2,Type7_t2,Type8_t2> &&tuple )
	// Move assign from rvr tuple to enable std::tie like behaviour
	{
		_0 = std::move(tuple._0);
		_1 = std::move(tuple._1);
...
public:
	...
	template <typename Type0_t2, typename Type1_t2, typename Type2_t2, typename Type3_t2, typename Type4_t2, typename Type5_t2, typename Type6_t2, typename Type7_t2, typename Type8_t2, typename Type9_t2>
	FORCEINLINE constexpr auto & operator=( CTuple<Type0_t2,Type1_t2,Type2_t2,Type3_t2,Type4_t2,Type5_t2,Type6_t2,Type7_t2,Type8_t2,Type9_t2> &&tuple )
	// Move assign from rvr tuple to enable std::tie like behaviour
	{
		_0 = std::move(tuple._0);
		_1 = std::move(tuple._1);
...
public:
	...
	template <typename Type0_t2, typename Type1_t2, typename Type2_t2, typename Type3_t2, typename Type4_t2, typename Type5_t2, typename Type6_t2, typename Type7_t2, typename Type8_t2, typename Type9_t2, typename Type10_t2>
	FORCEINLINE constexpr auto & operator=( CTuple<Type0_t2,Type1_t2,Type2_t2,Type3_t2,Type4_t2,Type5_t2,Type6_t2,Type7_t2,Type8_t2,Type9_t2,Type10_t2> &&tuple )
	// Move assign from rvr tuple to enable std::tie like behaviour
	{
		_0 = std::move(tuple._0);
		_1 = std::move(tuple._1);
...
public:
	...
	template <typename Type0_t2, typename Type1_t2, typename Type2_t2, typename Type3_t2, typename Type4_t2, typename Type5_t2, typename Type6_t2, typename Type7_t2, typename Type8_t2, typename Type9_t2, typename Type10_t2, typename Type11_t2>
	FORCEINLINE constexpr auto & operator=( CTuple<Type0_t2,Type1_t2,Type2_t2,Type3_t2,Type4_t2,Type5_t2,Type6_t2,Type7_t2,Type8_t2,Type9_t2,Type10_t2,Type11_t2> &&tuple )
	// Move assign from rvr tuple to enable std::tie like behaviour
	{
		_0 = std::move(tuple._0);
		_1 = std::move(tuple._1);
...
template<typename... types>
constexpr CTuple<types&...> CTie(types&... args) noexcept
{
	return {args...};
}
